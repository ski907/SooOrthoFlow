...
def recalibrate_single_camera(image_path, gcp_file, camera_id, dem_path,
    ...
    # Note: Cache files deleted above will be regenerated by the pipeline as needed
    print(f"  ✓ Old caches deleted - will be regenerated by pipeline at required resolutions")
